...
export default function ColoursShapes() {
    ...
    <div className="min-h-screen bg-background p-6 md:p-10">
      <div className="max-w-6xl mx-auto">
        <header className="flex items-center gap-5 mb-8 bg-card rounded-[2rem] p-6 border-4 border-card-border shadow-md">
          ...
          <div>
            <h1 className="text-4xl md:text-5xl font-black text-foreground">Colours & Shapes 🎨</h1>
            <p className="text-xl font-bold text-muted-foreground">Learn colours and shapes!</p>
          </div>
        </header>
